...
related_posts: true
featured: true
thumbnail: assets/img/oncocite.png
mermaid:
  enabled: true
toc:
  sidebar: left
...
This is a simplified view of [OncoCITE](/projects/1_oncocite/), a system that automatically extracts genomic evidence from scientific papers. I'll be writing more about the architecture decisions and lessons learned.
